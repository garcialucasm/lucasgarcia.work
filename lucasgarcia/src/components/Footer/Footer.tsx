      ...
      >
        ...
        <div className="flex gap-x-8 text-4xl">
          <Magnetic>
            ...
            >
              <div
                className={`rounded-lg p-2 hover:border-opacity-25 hover:bg-opacity-30 ${selected === ToggleButtonOptions.BACKEND ? "hover:bg-neutral-700" : "hover:bg-slate-300"}`}
              >
                <PiLinkedinLogoFill />
              </div>
            </a>
          ...
          <Magnetic>
            ...
            >
              <div
                className={`rounded-lg p-2 hover:border-opacity-25 hover:bg-opacity-30 ${selected === ToggleButtonOptions.BACKEND ? "hover:bg-neutral-700 hover:text-white" : "hover:bg-slate-300"}`}
              >
                <PiGithubLogoFill />
              </div>
            </a>
